...
run_agent() {
  ...
  (
    ...
    AGENT_ID="$agent" TEAM_LORE="$board_lore" TEAM_RUN_DIR="$runtime" \
      ...
      "$pi" --provider aiw1 --model "$model" --thinking off --print \
